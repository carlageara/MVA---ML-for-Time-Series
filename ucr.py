...
import scikit_wrappers#_updated as scikit_wrappers
import warnings
...
def fit_hyperparameters(file, train, train_labels, cuda, gpu,
    ...
    params['cuda'] = cuda
    params['gpu'] = gpu
    #print('n_neg:', params['nb_random_samples'])
...
if __name__ == '__main__':
    ...
    train += numpy.random.normal(0.0,1.0, train.shape)*args.train_noise*(numpy.random.random()>0.5*args.data_aug)
    test += numpy.random.normal(0.0,1.0, test.shape)*args.test_noise
